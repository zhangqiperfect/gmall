...
public class SpuInfoController {
    ...
    @GetMapping
    public Resp<PageVo> querySpuInfoByKey(@RequestParam(value = "catId",defaultValue = "0")Long catId,QueryCondition condition){
        PageVo pageVo= this.spuInfoService.querySpuInfoByKey(catId,condition);
